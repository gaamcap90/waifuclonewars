...
const CARD_DEFS: CardDef[] = [
  ...
  // ── Yi Sun-sin ───────────────────────────────────────────────────────────────
  {
    ...
    type: "attack",
    rarity: "rare",
    description: "Power×1.2 damage at range 3. Pushes target back 1 hex.",
    exclusiveTo: CHARACTER_IDS.sunsin,
    effect: { powerMult: 1.2, range: 3, pushback: 1 },
  },
  {
    definitionId: "sunsin_naval_command",
    name: "Naval Command / Broadside",
    manaCost: 3,
    type: "buff",
    rarity: "rare",
    description: "+15% Might & Power to all allies for 2 turns.",
    exclusiveTo: CHARACTER_IDS.sunsin,
    effect: { atkBonus: 15, teamDmgPct: 15, turns: 2 },
  },
  {
    definitionId: "sunsin_broadside",
    name: "Broadside",
    manaCost: 3,
    type: "attack",
    rarity: "rare",
    description: "Power×0.7 to all enemies in range 3.",
    exclusiveTo: CHARACTER_IDS.sunsin,
    effect: { powerMult: 0.7, allEnemiesInRange: true, range: 3 },
  },
  {
    ...
    type: "ultimate",
    rarity: "ultimate",
    description: "ULTIMATE (Exhaust) — Power×2.0 to all enemies in range 5.",
    exclusiveTo: CHARACTER_IDS.sunsin,
    effect: { powerMult: 2.0, range: 5, allEnemiesInRange: true },
  },
];
